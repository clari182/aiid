const config = {
  ...
  sidebar: {
    navConfig: [
      { title: 'Welcome to the AIID', label: 'welcome', url: '/', items: [], collapsed: false },
      {
        title: 'Discover Incidents',
        label: 'discover',
        url: '/apps/discover/',
        items: [],
        collapsed: true,
      ...
      { title: 'Entities', label: 'entities', url: '/entities/', items: [], collapsed: true },
      {
        title: 'Taxonomies',
        label: 'taxonomies',
        url: '/taxonomies/',
      ...
      { title: 'Blog', label: 'blog', url: '/blog/', items: [], collapsed: false },
    ],
    frontline: true,
    ignoreIndex: false,
  },
